    ...
    def sopa_letras(rooms,preguntas,lado,usuario):
        class Cursor:
            def __init__(self, fila, columna):
                ...
                self.avanzarX = [-1, 0, 1][random.randint(0,2)]
                self.avanzarY = [-1, 0, 1][random.randint(0,2)]
                if self.avanzarX == 0 and self.avanzarY == 0:
                    self.avanzarX = 1
        ...
        #if pista_contador_G == 0:
        #    pista = ""
        pista1 = pregunta['clue_1']
        pista2 = pregunta['clue_2']
        pista3 = pregunta['clue_3']
...
#
    ...
    def Pipes(rooms,preguntas,lado,usuario):
        ...
        print("(TIENES SOLO 2 MINUTOS PARA TERMINAR PIPES)")
        tiempo = 2
        ...
        while ciclo:
            ...
            if perdiste >= salida:
                ...
                break
            count =0
            print("\nte queda de tiempo: ",salida - perdiste)
